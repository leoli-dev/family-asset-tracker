...
export const TRANSLATIONS = {
  [Language.EN]: {
    ...
    'manage.noItems': 'No Items',
    'manage.noItemsDesc': 'Use the "+" button to create new items.',
    'manage.noCategory': 'No Category',
    'manage.noOwner': 'No Owner',
    'form.update': 'Update',
    'form.create': 'Save',
    'form.color': 'Color',
    ...
    'form.type': 'Type',
    'form.selectColor': 'Select Color',
    'nav.accounts': 'Accounts',
    'type.asset': 'Asset',
    'type.liability': 'Liability',
    'account.noAccounts': 'No accounts yet. Add one from the + menu.',
    'account.noRecords': 'No records',
    'account.noRecordsYet': 'No records yet.',
    'account.deleteRecord': 'Delete this record?',
    'history.cannotEdit': 'Cannot edit in Demo Mode',
    'history.unknownOwner': 'Unknown Owner',
    'history.uncategorized': 'Uncategorized',
    'dash.groupBy': 'Group By:',
    'dash.noActiveAssets': 'No active assets (> 0).',
    'dash.noActiveLiabilities': 'No active liabilities (> 0).',
    'entry.editTitle': 'Edit Record',
    'entry.update': 'Update Record',
    'entry.noAccount': 'Please create at least one Account first.',
    'entry.noAccountFound': 'No accounts found. Please add one.',
  },
  [Language.FR]: {
    ...
    'manage.noItems': 'Aucun élément',
    'manage.noItemsDesc': 'Utilisez "+" pour créer de nouveaux éléments.',
    'manage.noCategory': 'Sans catégorie',
    'manage.noOwner': 'Sans propriétaire',
    'form.update': 'Mettre à jour',
    'form.create': 'Enregistrer',
    'form.color': 'Couleur',
    'form.accountName': 'Nom du compte',
    'form.ownerName': 'Nom du propriétaire',
    'form.categoryName': 'Nom de la catégorie',
    'form.type': 'Type',
    'form.selectColor': 'Choisir une couleur',
    'nav.accounts': 'Comptes',
    'type.asset': 'Actif',
    'type.liability': 'Passif',
    'account.noAccounts': 'Aucun compte. Ajoutez-en un via le menu +.',
    'account.noRecords': 'Aucun relevé',
    'account.noRecordsYet': 'Aucun relevé pour le moment.',
    'account.deleteRecord': 'Supprimer ce relevé ?',
    'history.cannotEdit': 'Impossible de modifier en mode démo',
    'history.unknownOwner': 'Propriétaire inconnu',
    'history.uncategorized': 'Sans catégorie',
    'dash.groupBy': 'Grouper :',
    'dash.noActiveAssets': 'Aucun actif (> 0).',
    'dash.noActiveLiabilities': 'Aucun passif (> 0).',
    'entry.editTitle': "Modifier l'entrée",
    'entry.update': 'Mettre à jour',
    'entry.noAccount': 'Veuillez créer au moins un compte d\'abord.',
    'entry.noAccountFound': 'Aucun compte. Veuillez en ajouter un.',
  },
  [Language.ZH]: {
    'app.title': '家庭资产管家',
    'nav.overview': '概览',
    ...
    'manage.noItems': '暂无项目',
    'manage.noItemsDesc': '点击”+”按钮创建新项目。',
    'manage.noCategory': '无分类',
    'manage.noOwner': '无成员',
    'form.update': '更新',
    'form.create': '保存',
    'form.color': '颜色',
    ...
    'form.type': '类型',
    'form.selectColor': '选择颜色',
    'nav.accounts': '账户',
    'type.asset': '资产',
    'type.liability': '负债',
    'account.noAccounts': '暂无账户，点击 + 菜单添加。',
    'account.noRecords': '暂无记录',
    'account.noRecordsYet': '暂无记录。',
    'account.deleteRecord': '确认删除此记录？',
    'history.cannotEdit': '演示模式不可编辑',
    'history.unknownOwner': '未知成员',
    'history.uncategorized': '未分类',
    'dash.groupBy': '分组：',
    'dash.noActiveAssets': '暂无有效资产 (> 0)。',
    'dash.noActiveLiabilities': '暂无有效负债 (> 0)。',
    'entry.editTitle': '编辑记录',
    'entry.update': '更新记录',
    'entry.noAccount': '请先创建至少一个账户。',
    'entry.noAccountFound': '未找到账户，请先添加。',
  }
};
